...
import { Camera, LayoutDashboard, Settings, TableProperties } from 'lucide-react';
      ...
      <div className="flex flex-col flex-1 p-4 md:p-6 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 space-y-4 md:space-y-0">
          ...
          <button
            ...
            className="flex items-center justify-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-xl shadow-sm transition-colors"
          >
