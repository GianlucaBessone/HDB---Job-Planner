        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                    <select value={selectedKpiId} onChange={e => setSelectedKpiId(e.target.value)} className="h-9 px-3 border border-slate-200 dark:border-slate-600 rounded-lg text-sm bg-card text-card-foreground text-slate-700 dark:text-slate-200">
            ...
            {mediciones.length === 0 ? (
                ...
                <div className="bg-card text-card-foreground border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden shadow-sm">
                    ...
                    <div className="px-4 py-3 border-t border-slate-200 dark:border-slate-700 bg-background text-foreground/30 text-xs text-slate-400">
