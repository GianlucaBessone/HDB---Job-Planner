...
export const DEFAULT_VIEWS: ViewConfig[] = [
    ...
    { key: '/mis-epp',       label: 'Mis EPP',                description: 'Protección personal y firmas',    roles: ['operador', 'supervisor', 'admin', 'qa'],    access: 'ambos', section: 'operaciones', iconName: 'ShieldCheck',   color: 'bg-emerald-600' },
    ...
    { key: '/ordenes-trabajo',    label: 'Órdenes de Trabajo',       description: 'Ciclo completo y portal',     roles: ['operador', 'supervisor', 'admin', 'qa', 'vendedor'], access: 'ambos', section: 'gestion', iconName: 'FileText', color: 'bg-blue-700' },
    ...
    { key: '/rrhh',           label: 'Recursos Humanos',     description: 'Reclutamiento y Gestión de Personal', roles: ['admin', 'supervisor', 'qa'],                          access: 'ambos', section: 'administracion', iconName: 'Briefcase', color: 'bg-indigo-600' },
