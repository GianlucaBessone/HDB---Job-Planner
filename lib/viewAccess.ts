...
export const DEFAULT_VIEWS: ViewConfig[] = [
    { key: '/', label: 'Inicio', roles: ['operador', 'supervisor', 'admin', 'qa', 'vendedor'], access: 'sidebar' },
    { key: '/fichado', label: 'Fichado (GPS/QR)', roles: ['operador', 'supervisor'], access: 'ambos' },
    { key: '/my-projects', label: 'Mis Proyectos (Resp.)', roles: ['operador', 'supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/timesheets', label: 'Registro de Tiempos', roles: ['operador', 'supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/delays', label: 'Demoras del Cliente', roles: ['operador', 'supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/dashboard', label: 'Panel de Análisis', roles: ['supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/planning', label: 'Planificación', roles: ['supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/projects', label: 'Gestión de Proyectos', roles: ['supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/ordenes-servicio', label: 'Órdenes de Servicio', roles: ['supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/inventario', label: 'Inventario de Materiales', roles: ['admin', 'qa', 'vendedor'], access: 'sidebar' },
    { key: '/provision-materiales', label: 'Provisión de Materiales', roles: ['vendedor', 'supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/operators', label: 'Gestión de Usuarios', roles: ['operador', 'supervisor', 'admin', 'qa', 'vendedor'], access: 'ambos' },
    { key: '/clients', label: 'Gestión de Clientes', roles: ['supervisor', 'admin', 'qa', 'vendedor'], access: 'ambos' },
    { key: '/aprobaciones', label: 'Aprobaciones', roles: ['supervisor', 'admin', 'qa'], access: 'ambos' },
    { key: '/monitoreo-fichadas', label: 'Monitoreo de Fichadas', roles: ['supervisor', 'admin', 'qa'], access: 'sidebar' },
    { key: '/auditoria', label: 'Auditoría', roles: ['admin', 'qa', 'supervisor'], access: 'ambos' },
    { key: '/configuracion', label: 'Configuración', roles: ['admin', 'qa', 'supervisor'], access: 'ambos' },
    { key: '/carros', label: 'Carros de Herramientas', roles: ['operador', 'supervisor', 'admin', 'qa'], access: 'ambos' },
