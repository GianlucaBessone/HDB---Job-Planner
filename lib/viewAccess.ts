...
export const DEFAULT_VIEWS: ViewConfig[] = [
    ...
    { key: '/rrhh',           label: 'Recursos Humanos',     description: 'Reclutamiento y ATS',        roles: ['admin', 'supervisor', 'qa'],                          access: 'ambos', section: 'administracion', iconName: 'Briefcase', color: 'bg-indigo-600' },
