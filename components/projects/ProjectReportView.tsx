...
export default function ProjectReportView({ project }: ProjectReportViewProps) {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground/50 py-8 print:p-0 print:bg-white text-slate-800 dark:text-slate-100 font-sans mx-auto max-w-[950px] px-4 md:px-6">
            ...
            {project.proyectoFijo && (
                <div className="mb-6 p-3.5 md:p-4 bg-card text-card-foreground rounded-2xl border border-indigo-100 dark:border-indigo-900/50 shadow-sm print:hidden">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
                        ...
                        <div className="flex flex-wrap items-center gap-1.5">
                            <div className="flex items-center gap-1.5 bg-background dark:bg-slate-900/60 h-8 px-2.5 rounded-lg border border-slate-200 dark:border-slate-700 text-xs">
                                <span className="font-bold text-slate-400 dark:text-slate-500 text-[11px]">Desde:</span>
                                <input
                                    type="date"
                                    value={startDate}
                                    onChange={(e) => setStartDate(e.target.value)}
                                    className="bg-transparent text-slate-800 dark:text-slate-200 font-semibold text-xs outline-none cursor-pointer py-0"
                                />
                            </div>
                            <div className="flex items-center gap-1.5 bg-background dark:bg-slate-900/60 h-8 px-2.5 rounded-lg border border-slate-200 dark:border-slate-700 text-xs">
                                <span className="font-bold text-slate-400 dark:text-slate-500 text-[11px]">Hasta:</span>
                                <input
                                    type="date"
                                    value={endDate}
                            ...
                            <button
                                ...
                                type="button"
                                className="h-8 px-2.5 text-[11px] font-bold rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 transition-colors"
                            >
                                Este Mes
                            </button>
                            <button
                            ...
                            {isFilterActive && (
                                <button
                                    ...
                                    type="button"
                                    title="Ver todo"
                                    className="flex items-center gap-1 h-8 px-2.5 text-[11px] font-bold rounded-lg bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 hover:bg-rose-100 transition-colors"
                                >
                    ...
                    {isFilterActive && (
                        <div className="mt-2.5 pt-2.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-[11px] text-indigo-600 dark:text-indigo-400 font-semibold">
                            <span>
