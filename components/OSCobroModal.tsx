    ...
    const generatePdfContent = () => `
        ...
        <div class="header">
            <div>
                ...
                <h2 style="margin-top:8px;">Orden de Cobro — ${os.codigoOS || os.id.slice(-8).toUpperCase()}</h2>
                            ...
                            {materiales.length > 0 && (
                                <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        {materiales.map(m => (
                                            <div key={m.id} className="grid grid-cols-[1fr_80px_120px_120px] gap-3 items-center text-sm border-b border-slate-50 pb-3 last:border-0 last:pb-0">
                                                <div className="font-bold text-slate-700 truncate" title={m.material}>{m.material}</div>
                                                <div className="text-center font-bold text-slate-500 bg-slate-100 rounded-lg py-1">{m.cantidad}</div>
