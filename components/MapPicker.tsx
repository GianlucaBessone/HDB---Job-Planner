...
const DynamicMapPicker = dynamic(
    ...
    { 
        ssr: false,
        loading: () => (
            <div className="h-[300px] w-full bg-background text-foreground/50 border border-slate-200 dark:border-slate-700 rounded-2xl flex flex-col items-center justify-center gap-2">
